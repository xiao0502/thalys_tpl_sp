...
const KEY_BIT_SIZE = 128, byteToInt = (t, r) => {
    ...
    o = (255 & o) << 8;
    let p = t.charCodeAt(r + 3), i = e | n | o | (p &= 255);
    return Math.abs(i);
}, doMD5Sign = t => {
    let r = MD5(t, null, !0), e = byteToInt(r, 0), n = byteToInt(r, 4), o = byteToInt(r, 8), p = byteToInt(r, 12);
