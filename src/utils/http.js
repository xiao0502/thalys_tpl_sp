...
const install = (Vue, vm) => {
    ...
    let timer, loginTimer; // loading 计时器
    ...
    Vue.prototype.getImgUrl = (imgName) => {
        ...
        return `${config.imgBaseUrl}${imgName.slice(
            0,
            imgName.length - imgType.length - 1
        )}@${res.pixelRatio < 3 ? 2 : 3}x.${imgType}`;
    };
